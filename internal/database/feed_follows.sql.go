...
func (q *Queries) DeleteFeedFollowsForUser(ctx context.Context, arg DeleteFeedFollowsForUserParams) error {
	_, err := q.db.ExecContext(ctx, deleteFeedFollowsForUser, arg.Url, arg.UserID)
	return err
}

const getFeedFollowsForUser = `-- name: GetFeedFollowsForUser :many
SELECT feed_follows.id, feed_follows.created_at, feed_follows.updated_at, user_id, feed_follows.feed_id, users.id, users.created_at, users.updated_at, users.name, feeds.feed_id, feeds.created_at, feeds.updated_at, feeds.name, url, reference_id, last_fetched_at
FROM feed_follows
